  ...
  <div>
    <div style="margin: 20px;">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-button type="primary" @click="getChemokinePic">Click</el-button>
      </el-form>
    </div>
...
// 获取趋化因子图片
const getChemokinePic = () => {
  show.value = true
  loading.value = true
  png64.value = ""

  axios.get(`${baseURL}/r/immu/chemokine/${gene.value}`)
      .then(imgRes => {
...
const downloadDiffImg = () => {
  ...
  doc.save(`${gene.value}_chemokine_image.pdf`)
}
