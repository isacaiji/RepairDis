  ...
  <div>
    <div style="margin: 20px;">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-button type="primary" @click="getImmuinhibitorPic">Click</el-button>
      </el-form>
    </div>
...
// 获取免疫抑制剂图片
const getImmuinhibitorPic = () => {
  show.value = true
  loading.value = true
  png64.value = ""

  axios.get(`${baseURL}/r/immu/immuinhibitor/${gene.value}`)
      .then(imgRes => {
...
const downloadDiffImg = () => {
  ...
  doc.save(`${gene.value}_immuinhibitor_image.pdf`)
}
