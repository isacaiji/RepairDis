...
import PanCancerImmune from '@/Analysis/immume/PanCancerImmune.vue'
...
const menuTabs = {
  immune: [
    {label: 'Pan-cancer DDR-state', component: PanCancerImmune},
  ...
  base: [
    ...
    {label: 'Experssion', component: Expression},
