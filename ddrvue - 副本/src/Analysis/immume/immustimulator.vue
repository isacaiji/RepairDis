  ...
  <div>
    <div style="margin: 20px;">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-button type="primary" @click="getImmustimulatorPic">Click</el-button>
      </el-form>
    </div>
...
// 获取免疫刺激因子图片
const getImmustimulatorPic = () => {
  show.value = true
  loading.value = true
  png64.value = ""

  axios.get(`${baseURL}/r/immu/immustimulator/${gene.value}`)
      .then(imgRes => {
...
const downloadDiffImg = () => {
  ...
  doc.save(`${gene.value}_immustimulator_image.pdf`)
}
