  ...
  <div>
    <div style="margin: 20px;">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-button type="primary" @click="getImmunescorePic">Click</el-button>
      </el-form>
    </div>
...
// 获取免疫评分图片
const getImmunescorePic = () => {
  show.value = true
  loading.value = true
  png64.value = ""

  axios.get(`${baseURL}/r/immu/immunescore/${gene.value}`)
      .then(imgRes => {
...
const downloadDiffImg = () => {
  ...
  link.href = `${baseURL}/immu/down/immunescore/${gene.value}`
  link.click()
