  ...
  <div>
    <div style="margin: 20px;">
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-button type="primary" @click="getImmucellPic">Click</el-button>
      </el-form>
    </div>
...
// 获取免疫细胞图片
const getImmucellPic = () => {
  show.value = true
  loading.value = true
  png64.value = ""

  axios.get(`${baseURL}/r/immu/immucell/${gene.value}`)
      .then(imgRes => {
...
const downloadDiffImg = () => {
  ...
  doc.save(`${gene.value}_immucell_image.pdf`)
}
